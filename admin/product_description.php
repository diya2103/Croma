<?php
	...
	if(isset($_REQUEST['btn_submit']))
	{
        ...
        $pid = $_REQUEST['pid'];
        $query = "UPDATE product_entry SET description = '$d'  WHERE p_id = '$pid'";  
		...
		<form method="post" enctype="multipart/form-data">
            ...
            <div class="box-body border">
                ...
                <label for="floatingTextarea">Product description</label>
                    <textarea class="form-control" placeholder="description" name="description"><?php echo $desc; ?></textarea>
                </div>
