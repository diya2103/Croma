...
?>
		  ...
		  ?>
		   ...
		   {
		   ?>
		   <a href="rating.php?cc_code=<?php echo $cc=$row['cc_code']; ?>&p=<?php echo $cc=$row['cp_code']; ?>" title="Rating" class="btn btn-warning btn-md"><i class="fa fa-star"></i></a>
		   <?php
		   }
		   else
		   {
		   ?>
		   <b>Your Order can't Delivered</b>
		   <?php
		   }
		   ?> 
		   </td>
		  <td><?php if($row['cc_status']=='delivered')
		   {
		   ?>
		   <a href="bill.php?cc_code=<?php echo $cc=$row['cc_code']; ?>&p=<?php echo $cc=$row['cp_code']; ?>" title="Bill" class="btn btn-primary btn-md">Invoice</a>
		   <?php
		   }
		   else
		   {
